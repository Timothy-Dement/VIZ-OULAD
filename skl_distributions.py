...
if not os.path.exists('./charts/skl_distributions'):
    os.mkdir('./charts/skl_distributions')
...
for mod in mod_paths:
    ...
    for met in metrics:
        ...
        mod_plot.figure.savefig(f'./charts/skl_distributions/{mod}-{met}_skl_distributions.png')
