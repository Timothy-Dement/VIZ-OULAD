...
if not os.path.exists('./charts/distributions'):
    os.mkdir('./charts/distributions')
...
for mod in mod_paths:
    ...
    for met in metrics:
        ...
        mod_plot.figure.savefig(f'./charts/distributions/{mod}-{met}_distributions.png')
